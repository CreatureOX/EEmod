...
public class EEmodCursesGui extends GuiScreen{
    ...
    public void initGui(){
    	...
    	buttonList.add(btnCurse1 = new GuiButton(1, (int)(width*0.75), (int)(height*0.85)-40, 80, 20, "咒语2"));		
    	buttonList.add(btnCurse1 = new GuiButton(1, (int)(width*0.75), (int)(height*0.85)-60, 80, 20, "咒语3"));		
