...
public class ModWorldGenerator {
	...
	private static WorldGenerator ModgeneratorPurple = new ModWorldGeneratorPurple();
	private int posX;
	private int posZ;
...
//	  change mineral sample	
//    @SubscribeEvent
//    public void ModOreGenGenerateMinable(OreGenEvent.GenerateMinable event)
//    {
